        ...
        for date_key, categories in json_data.items():
            ...
            for category_name, events_list in categories.items():
                ...
                for event_info in sorted_events_list:
                    ...
                    channel_id = event_name  # CORREZIONE PRINCIPALE
                    ...
                    for channel_data in event_info.get("channels", []):
                        ...
                        if channel_id in last_event_end_time_per_channel_on_date:
                            previous_event_end_time_local = last_event_end_time_per_channel_on_date[channel_id]  # USA CHANNEL_ID (EVENT_NAME)
                        ...
                        if announcement_start_local < announcement_stop_local:
                            ...
                            print(f"[!] Attenzione: Orario di inizio annuncio successivo all'orario di fine per l'evento '{event_name}'. Annuncio saltato.")
                        ...
                        # Aggiorna l'orario di fine dell'ultimo evento per questo canale
